...
export const TERRAIN_SETS = {
  ...
  tunnelRun: set({
    ...
    propE: 0xffc46a,
    propEmissive: 1,
    ridgeNearColor: 0x30323c,
    ridgeFarColor: 0x555a68,
    hillHeight: 7,
    hillSharpness: 1.4,
    tunnel: 1,
    propDensity: 0.372,
  ...
  // Water on both sides and a railing either hand — the causeway control
  // already existed, this just drops the ground away symmetrically.
  riverCrossing: set({
    ...
    propA: 0x6a7360,
    propB: 0x55503f,
    ridgeNearColor: 0x6a7a72,
    ridgeFarColor: 0x9db4c0,
    waterColor: 0x3f6f7e,
    hillHeight: 1.2,
    causeway: 6.5,
    water: 0.92,
  ...
  saltFlats: set({
    ...
    propA: 0xb0aea4,
    propB: 0x8e8c84,
    ridgeNearColor: 0xcfcdc4,
    ridgeFarColor: 0xbfcdd8,
    hillHeight: 0.25,
    hillScale: 0.4,
    propDensity: 0.15,
    propScale: 1.1,
  ...
  autumnBirches: set({
    ...
    propA: 0xd8963a,
    propB: 0xd8d2c4, // pale birch bark
    ridgeNearColor: 0x8a7048,
    ridgeFarColor: 0xb49a78,
    hillHeight: 5.5,
    hillScale: 0.95,
    propDensity: 0.837,
    propScale: 1.05,
  ...
  highlandMoor: set({
    ...
    propB: 0x6e6a62,
    ridgeNearColor: 0x5e5c58,
    ridgeFarColor: 0x8a8c90,
    hillHeight: 11,
    hillSharpness: 1.25,
    hillScale: 0.75,
    propDensity: 0.605,
  ...
  lavenderFields: set({
    ...
    ridgeNearColor: 0x9a8aa8,
    ridgeFarColor: 0xb8b4d0,
    hillHeight: 3.6,
    hillScale: 0.75,
    propDensity: 0.883,
    propScale: 1.15,
  ...
  refineryCoast: set({
    ...
    propA: 0x343843,
    propB: 0x1e2129,
    propE: 0xff7a2a, // sodium and flare
    propEmissive: 1,
    skyNudge: 0x8a4a20,
    skyNudgeStrength: 0.35,
    ridgeNearColor: 0x23262f,
    ridgeFarColor: 0x3e4454,
    waterColor: 0x1e3038,
    hillHeight: 0.8,
    water: 0.8,
    waterSide: -1,
  ...
  canyonRoad: set({
    ...
    propA: 0x9a5030,
    propB: 0x7a3c22,
    ridgeNearColor: 0x8e4728,
    ridgeFarColor: 0xc98a5e,
    hillHeight: 20,
    hillSharpness: 1.7,
    hillScale: 1.1,
    cliffSide: 1,
  ...
  iceRoad: set({
    ...
    propA: 0x8fa0ac,
    propB: 0x6e7d88,
    ridgeNearColor: 0xb4c4d0,
    ridgeFarColor: 0xd0dce6,
    hillHeight: 1.0,
    hillScale: 0.5,
    propDensity: 0.279,
    ridgeOpacity: 0.5,
  ...
  blossomAvenue: set({
    ...
    propB: 0x6a4a3e,
    ridgeNearColor: 0xc8a8b4,
    ridgeFarColor: 0xd8c4d0,
    hillHeight: 2.4,
    hillScale: 0.8,
    propDensity: 0.93,
    propScale: 1.2,
